...
function ProfileHeader() {
    ...
    const [selectionImg, setSelectedImg] = useState(null);
    console.log(authUser,'jsfjlk')
                ...
                <div className='flex items-center gap-3'>
                    ...
                    <div className='avatar online'>
                        <button className='size-14 rounded-full overflow-hidden relative group' onClick={() => fileInputRef.current.click()}>
                            <img src={selectionImg || authUser.profilePic || "/avatar.png"} alt="User image" className='size-full object-cover' />
                    ...
                    <div><h3 className='text-slate-200 font-medium text-base max-w-[180px] truncate'>
                    {authUser.fullName}
                </h3>
